            ...
            <ul class="nav nav-tabs" id="detailsTabs" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="professional-tab" data-bs-toggle="tab" href="#professional" role="tab"
                        aria-controls="professional" aria-selected="false">Professional Details</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="financial-tab" data-bs-toggle="tab" href="#financial" role="tab"
                        aria-controls="financial" aria-selected="false">Financial Details</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="insurance-tab" data-bs-toggle="tab" href="#insurance" role="tab"
                        aria-controls="insurance" aria-selected="false">Insurance Details</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="investment-tab" data-bs-toggle="tab" href="#investment" role="tab"
                        aria-controls="investment" aria-selected="false">Investment Details</a>
                </li>
            </ul>
            <form method="POST" action="{{ route('customers.store') }}" id="combinedForm">
                ...
                <div class="tab-content mt-3" id="detailsTabContent">
                    ...
                    <div class="tab-pane fade show active" id="personal" role="tabpanel" aria-labelledby="personal-tab">
                        ...
                        <!-- Family Member  -->
                        {{-- <div class="family-details row" id="familyMembersContainer">
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="family[0][name]" class="form-label dpage5label">Family Member Name</label>
                ...
                <div class="tab-pane fade" id="financial" role="tabpanel" aria-labelledby="financial-tab">
                    ...
                    <!-- Add your financial details content here -->
                    <div class="row"> <!-- Type of Bank -->
                        <div class="col-lg-4">
                            <div class="mb-4">
                                <div class="form-group">
                                    <label for="type_of_bank" class="form-label dpage5label">Type of Bank</label>
                                    <input type="text" name="type_of_bank" id="type_of_bank"
                                        class="form-control dpage5input" placeholder="Enter Type of Bank">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="mb-4">
                                <div class="form-group">
                                    <label for="loan_type" class="form-label dpage5label">Loan Type</label>
                                    <input type="text" name="loan_type" id="loan_type"
                                        class="form-control dpage5input" placeholder="Enter Loan Type">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="mb-4">
                                <div class="form-group">
                                    <label for="loan_amount" class="form-label dpage5label">Loan Amount</label>
                                    <input type="number" step="0.01" name="loan_amount" id="loan_amount"
                                        class="form-control dpage5input" placeholder="Enter Loan Amount">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="mb-4">
                                <div class="form-group">
                                    <label for="EMI" class="form-label dpage5label">EMI</label>
                                    <input type="number" step="0.01" name="EMI" id="EMI"
                                        class="form-control dpage5input" placeholder="Enter EMI">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="mb-4">
                                <div class="form-group">
                                    ...
                                    <textarea name="comment" id="comment" class="form-control dpage5input" placeholder="Enter Comment"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-4">
                            <div class="mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="type_of_insurance_company" id="type_of_insurance_company"
                                        class="form-control dpage5input" placeholder="Enter insurance company type">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="premium" id="premium" class="form-control dpage5input"
                        ...
                        <div class="col-lg-4">
                            <div class="mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="financial_institute_name" id="financial_institute_name"
