...
<head>
    ...
    {{-- <link rel="shortcut icon" href="{{ asset('assets/img/fevicon.webp') }}" type="image/x-icon"> --}}
    <link href="{{ asset('assets/dashboard/vendor/datatables/dataTables.bootstrap4.min.css') }}" rel="stylesheet"
        type="text/css">

    <!-- ====== CSS ===== -->
    <link rel="stylesheet" href="{{ asset('assets/dashboard/css/sb-admin-2.css') }}" type="text/css">
    <link rel="stylesheet" href="{{ asset('assets/dashboard/css/sb-admin-2.min.css') }}" type="text/css">
    <link rel="stylesheet" href="{{ asset('assets/dashboard/css/style.css') }}" rel="stylesheet" type="text/css">
    ...
    {{-- <!-- jQuery (optional, but needed for custom JS functionality) -->
