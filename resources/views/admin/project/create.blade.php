...
@section('content')
    <div id="content" class="p-4">
        <!-- Dashboard Header -->
        <h1 class="ds1col1texth1">Add Project</h1>
            ...
            <form id="multiStepForm" method="POST" action="{{ route('projects.store') }}" enctype="multipart/form-data">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-secondary" id="addMorePropertyDetails">Add More Property Details</button>
                    </div>
                </div>

                <!-- Card 5: Property Units -->
                <div class="card mb-4">
                    <div class="card-header">
                        <h3>Property Units</h3>
                    </div>
                    <div class="card-body">
                        <div id="propertyUnitContainer">
                            <div class="row mb-4">
                                <div class="col-lg-6">
                                    <label for="property_unit[title][]" class="form-label">Unit Title</label>
                                    <input type="text" name="property_unit[title][]" class="form-control"
                                        placeholder="Enter unit title...">
                                </div>
                                <div class="col-lg-6">
                                    <label for="property_unit[description][]" class="form-label">Unit Description</label>
