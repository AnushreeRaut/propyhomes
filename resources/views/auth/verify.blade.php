            ...
            <div class=" container py-5 px-2 px-lg-5  ">
                ...
                <div class=" d-flex flex-wrap  justify-content-center pt-4 gap-5">
                    ...
                    <div class=" p2s3W text-center pt-2">
                        <img src="{{ asset('assets/frontend/asset/img/sbi.BchWMqiI.png') }}" width="177.43px"
                            class="mt-1" alt="">
                    </div>
                    <div class=" p2s3W text-center pt-3">
                        <img src="{{ asset('assets/frontend/asset/img/axis_bank.png') }}" width="187.28px"
                            alt="">
                    </div>
                    <div class=" p2s3W text-center pt-2">
                        <img src="{{ asset('assets/frontend/asset/img/HDFC.png') }}" width="179.22px" height="65.06px"
                            class="mt-1" alt="">
                    </div>
                    <div class=" p2s3W text-center p-2 pt-2">
                        <img src="{{ asset('assets/frontend/asset/img/IDFC_first_bank.png') }}" width="100%"
                            height="64.16px" class="mt-1" alt="">
                    </div>
                    <div class=" p2s3W text-center p-2 pt-3">
                        <img src="{{ asset('assets/frontend/asset/img/housing_planing.png') }}" width="194px"
                            height="49px" class="mt-1" alt="">
                    </div>
                    <div class=" p2s3W text-center p-2 pt-3">
                        <img src="{{ asset('assets/frontend/asset/img/bajaj-finserv.BTPhVn59.png') }}" width="180px"
                            height="48pxx" class="mt-1" alt="">
                    </div>
                    <div class=" p2s3W text-center p-2 pt-3">
                        <img src="{{ asset('assets/frontend/asset/img/abc.DqPl8JZM.png') }}" width="200px"
                            height="40px" class="mt-2" alt="">
                    </div>
                    <div class=" p2s3W text-center p-2 pt-2">
                        <img src="{{ asset('assets/frontend/asset/img/icici.mBYNUJmr.png') }}" width="189px"
                            height="38px" class="mt-3" alt="">
                    </div>
