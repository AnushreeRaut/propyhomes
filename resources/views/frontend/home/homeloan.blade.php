 ...
 <!-- +++++++++++  section 1  +++++++++++ -->
    ...
    <section class="section mt-4">
        <div class="p2s1bgimg p2s1height">
            ...
            <div class="container pt-3 pt-sm-5  position-relative  h-100">
                ...
                <div class="row position-absolute top-100  translate-middle rounded-4 p-4    p2s2bgc">
                    <div class="col-lg-8 home_s1_padding ">
                        <div class="p2s2pdiv">
                    ...
                    <div class="col-lg-4 p2p1col2 rounded-3 p-4 px-3 px-xl-5 bg-white">
                        <div class="">
                            <div class="text-center p2s2c2text">
                                ...
                                <h4><span id="dynamic-amount"></span></h4>
                            </div>
                            <div class="  ">
                            ...
                            <div class="text-center p2s2col2btn pt-lg-1  pt-4">
                                ...
                                <div class="d-grid gap-2 pt-4">
                                    <button class="btn  " data-bs-toggle="modal" data-bs-target="#exampleModal">Get in
                                        Touch</button>
                                </div>
    ...
    <div class="container">
        <div class="row p2s2_border">
            <div class="col-lg-3 col-md-6 col-12 text-center my-2">
                <img src="{{asset('assets/frontend/asset/img/person.png')}}" width="40px" alt="">
                <p class="p2s2Tp pt-3">Maximum Eligibility</p>
            </div>
            <div class="col-lg-3 col-md-6 col-12 text-center my-2">
                <img src="{{asset('assets/frontend/asset/img/downarrimg.png')}}" width="40px" alt="">
                <p class="p2s2Tp pt-3">Maximum Tenure</p>
            </div>
            <div class="col-lg-3 col-md-6 col-12 text-center my-2">
                <img src="{{asset('assets/frontend/asset/img/homloadn.png')}}" width="40px" alt="">
                <p class="p2s2Tp pt-3">Design Your EMI</p>
            </div>
            <div class="col-lg-3 col-md-6 col-12 text-center my-2">
                <img src="{{asset('assets/frontend/asset/img/calendar.png')}}" width="40px" alt="">
    ...
    <div class=" container py-5 px-2 px-lg-5  ">
        ...
        <div class=" d-flex flex-wrap  justify-content-center pt-4 gap-5">
            ...
            <div class=" p2s3W text-center pt-2">
                <img src="{{asset('assets/frontend/asset/img/sbi.BchWMqiI.png')}}" width="177.43px" class="mt-1" alt="">
            </div>
            <div class=" p2s3W text-center pt-3">
                <img src="{{asset('assets/frontend/asset/img/axis_bank.png')}}" width="187.28px" alt="">
            </div>
            <div class=" p2s3W text-center pt-2">
                <img src="{{asset('assets/frontend/asset/img/HDFC.png')}}" width="179.22px" height="65.06px" class="mt-1" alt="">
            </div>
            <div class=" p2s3W text-center p-2 pt-2">
                <img src="{{asset('assets/frontend/asset/img/IDFC_first_bank.png')}}" width="100%" height="64.16px" class="mt-1" alt="">
            </div>
            <div class=" p2s3W text-center p-2 pt-3">
                <img src="{{asset('assets/frontend/asset/img/housing_planing.png')}}" width="194px" height="49px" class="mt-1" alt="">
            </div>
            <div class=" p2s3W text-center p-2 pt-3">
                <img src="{{asset('assets/frontend/asset/img/bajaj-finserv.BTPhVn59.png')}}" width="180px" height="48pxx" class="mt-1" alt="">
            </div>
            <div class=" p2s3W text-center p-2 pt-3">
                <img src="{{asset('assets/frontend/asset/img/abc.DqPl8JZM.png')}}" width="200px" height="40px" class="mt-2" alt="">
            </div>
            <div class=" p2s3W text-center p-2 pt-2">
                <img src="{{asset('assets/frontend/asset/img/icici.mBYNUJmr.png')}}" width="189px" height="38px" class="mt-3" alt="">
            </div>
    ...
    <script>
        ...
        const pieChart = new Chart(ctx, {
            ...
            options: {
                ...
                plugins: {
                    legend: {
                        display: true // Show legend for Loan and Interest
                    }
                }
            }
        });
        ...
        function updateLoanDetails() {
            const income = incomeRange.value * 10000; // Monthly income (e.g., 80000 -> ₹80,000)
            const interestRate = interestRange.value; // Annual interest rate (e.g., 1.1%)
            const tenureYears = tenureRange.value; // Tenure in years (e.g., 3 years)
            const tenureMonths = tenureYears * 12; // Convert tenure to months
            const emi = emiRange.value; // Other EMIs (₹0 in this case)

            // 50% of income is available for EMI payments
            const maxEmi = (income - emi) * 0.50; // Assuming 50% of income goes towards EMI

            // Calculate loan eligibility based on EMI formula
            let loanAmount = 0;
            if (interestRate > 0) {
                const monthlyRate = interestRate / 12 / 100;
                loanAmount = (maxEmi * (1 - Math.pow(1 + monthlyRate, -tenureMonths))) / monthlyRate;
            } else {
                loanAmount = maxEmi * tenureMonths; // If interest rate is 0
            }
            ...
            const calculatedEMI = calculateEMI(loanAmount, interestRate, tenureMonths);

            // Calculate total interest payable
            const totalInterest = calculateTotalInterest(calculatedEMI, loanAmount, tenureMonths);

            // Update the dynamic amount, loan amount, and interest details
            dynamicAmountElement.textContent = formatLoanAmount(loanAmount);
            loanAmountElement.textContent = formatLoanAmount(loanAmount);
            totalInterestElement.textContent = formatLoanAmount(totalInterest);
            emiDisplay.innerHTML = `₹${calculatedEMI.toFixed(2).toLocaleString()} / Month`;
        ...
        // Function to format loan amount in lakhs and crores
        ...
        // Event listeners for the input range elements to update values dynamically
        incomeRange.addEventListener('input', function () {
            incomeValue.textContent = (incomeRange.value * 10000).toLocaleString();
            updateLoanDetails();
        });

        interestRange.addEventListener('input', function () {
            interestValue.textContent = interestRange.value;
            updateLoanDetails();
        });

        tenureRange.addEventListener('input', function () {
            tenureValue.textContent = tenureRange.value;
            updateLoanDetails();
        });

        emiRange.addEventListener('input', function () {
            emiValue.textContent = emiRange.value;
            updateLoanDetails();
        });
