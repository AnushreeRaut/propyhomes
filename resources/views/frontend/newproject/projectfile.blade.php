        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-8 col-lg-12   mb-xl-2 mb-5">
                                        ...
                                        @if($detail)
                                            <div class="d-flex pt-2 justify-content-between align-items-center">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <h5 class="">
                                                        <img src="{{ asset('assets/frontend/img/icon-placeholder.svg') }}" class="pe-3 pe-xxl-4" alt="">
                                                    </h5>
                                                    <h5 class="psec2c1font">{{ ucfirst($detail->title) }}:</h5>
                                                </div>
                                                <h5 class="psec2c1font psec2c1Weight1">{{ $detail->value ?? 'Not Available' }}</h5>
                                            </div>
                                        @endif
                                    @endforeach
                                    </div>
                    ...
                    <div class="p-4 psec2bordeS rounded-2 mt-5">
                        <div class="">
                            ...
                            <div class="text-center text-lg-start">
                                ...
                                @else
                                    <!-- Display a default image or message when no video is available -->
                                    <img src="/asset/img/video.png" width="100%" alt="Default Video Thumbnail" class="rounded-2">
                                    <p class="text-muted mt-2">No video available for this project.</p>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-4 psec2bordeS rounded-2 mt-5">
                        <div class="">
                            <h4 class="psec2c1h pb-3">{{ $project->title }} Floor Plan</h4>
                            <div class="text-center text-lg-start">
                                @if($project->floor_plan_image)
                                    <img src="{{ asset($project->floor_plan_image) }}" class="rounded-2" width="80%" alt="{{ $project->title }} Floor Plan Image">
                                @else
                                    <img src="/asset/img/bajatypicFloor.png" class="rounded-2" width="80%" alt="Default Floor Plan Image">
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-4 psec2bordeS rounded-2 mt-5">
                        <div class="">
                            <div class="p-4 psec2bordeS rounded-2 mt-5">
                                ...
                                <div class="mb-4">
                                    @if ($project->google_link)
                                        <a href="{{ $project->google_link }}" target="_blank">View Location on Google Maps</a>
                                    @else
                                        <p>Location link not available.</p>
                                    @endif
                                </div>
                                ...
                                <div>
                                    @if ($project->google_link)
                                        <iframe class="rounded-2"
                                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14883.952777874674!2d79.06923235000001!3d21.1528681!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bd4c0f3e818514f%3A0x516fde42a47384a3!2sCivil%20Lines%2C%20Nagpur%2C%20Maharashtra%20440001!5e0!3m2!1sen!2sin!4v1727522511244!5m2!1sen!2sin"
