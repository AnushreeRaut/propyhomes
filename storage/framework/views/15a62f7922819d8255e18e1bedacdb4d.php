        ...
        <div class="container my-1 py-5">
            <div class="row ">
                <div class="col-xl-2 col-lg-3 col-md-3 col-sm-6 col-12 mb-4 ">
                    <div class="text-center sec2bor rounded-3 py-2 h-100">
                        <div class="text-center">
                            <img src="<?php echo e(asset('assets/frontend/img/v1.png')); ?>" width="50%" alt=""
                                class="sec1Imgb">
                        </div>
                ...
                <div class="col-xl-2 col-lg-3 col-md-3 col-sm-6 col-12 mb-4 ">
                    <div class="text-center sec2bor rounded-3 py-2 h-100">
                        <div class="text-center">
                            <img src="<?php echo e(asset('assets/frontend/img/v2.png')); ?>" width="50%" alt=""
                                class="sec1Imgb">
                        </div>
                ...
                <div class="col-xl-2 col-lg-3 col-md-3 col-sm-6 col-12 mb-4 ">
                    <div class="text-center sec2bor rounded-3 py-2 h-100">
                        <div class="text-center">
                            <img src="<?php echo e(asset('assets/frontend/img/v3.png')); ?>" width="50%" alt=""
                                class="sec1Imgb">
                        </div>
                ...
                <div class="col-xl-2 col-lg-3 col-md-3 col-sm-6 col-12 mb-4 ">
                    <div class="text-center sec2bor rounded-3 py-2 h-100">
                        <div class="text-center">
                            <img src="<?php echo e(asset('assets/frontend/img/v4.png')); ?>" width="50%" alt=""
                                class="sec1Imgb">
                        </div>
                ...
                <div class="col-xl-2 col-lg-3 col-md-3 col-sm-6 col-12 mb-4 ">
                    <div class="text-center sec2bor rounded-3 py-2 h-100">
                        <div class="text-center">
                            <img src="<?php echo e(asset('assets/frontend/img/v5.png')); ?>" width="50%" alt=""
                                class="sec1Imgb">
                        </div>
                ...
                <div class="col-xl-2 col-lg-3 col-md-3 col-sm-6 col-12 mb-4 ">
                    <div class="text-center sec2bor rounded-3 py-2 h-100">
                        <div class="text-center">
                            <img src="<?php echo e(asset('assets/frontend/img/v6.png')); ?>" width="50%" alt=""
                                class="sec1Imgb">
                        </div>
                ...
                <div class="col-xl-2 col-lg-3 col-md-3 col-sm-6 col-12 mb-4 ">
                    <div class="text-center sec2bor rounded-3 py-2 h-100">
                        <div class="text-center">
                            <img src="<?php echo e(asset('assets/frontend/img/v7.png')); ?>" width="50%" alt=""
                                class="sec1Imgb">
                        </div>
                ...
                <div class="col-xl-2 col-lg-3 col-md-3 col-sm-6 col-12 mb-4 ">
                    <div class="text-center sec2bor rounded-3 py-2 h-100">
                        <div class="text-center">
                            <img src="<?php echo e(asset('assets/frontend/img/v8.png')); ?>" width="50%" alt=""
                                class="sec1Imgb">
                        </div>
                ...
                <div class="col-xl-2 col-lg-3 col-md-3 col-sm-6 col-12 mb-4 ">
                    <div class="text-center sec2bor rounded-3 py-2 h-100">
                        <div class="text-center">
                            <img src="<?php echo e(asset('assets/frontend/img/v9.png')); ?>" width="50%" alt=""
                                class="sec1Imgb">
                        </div>
                ...
                <div class="col-xl-2 col-lg-3 col-md-3 col-sm-6 col-12 mb-4 ">
                    <div class="text-center sec2bor rounded-3 py-2 h-100">
                        <div class="text-center">
                            <img src="<?php echo e(asset('assets/frontend/img/v10.png')); ?>" width="50%" alt=""
                                class="sec1Imgb">
                        </div>
                ...
                <div class="col-xl-2 col-lg-3 col-md-3 col-sm-6 col-12 mb-4 ">
                    <div class="text-center sec2bor rounded-3 py-2 h-100">
                        <div class="text-center">
                            <img src="<?php echo e(asset('assets/frontend/img/v11.png')); ?>" width="50%" alt=""
                                class="sec1Imgb">
                        </div>
                ...
                <div class="col-xl-2 col-lg-3 col-md-3 col-sm-6 col-12 mb-4 ">
                    <div class="text-center sec2bor rounded-3 py-2 h-100">
                        <div class="text-center">
                            <img src="<?php echo e(asset('assets/frontend/img/v12.png')); ?>" width="50%" alt=""
                                class="sec1Imgb">
                        </div>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide ">
                        <div class=" position-relative sec2Macard rounded-3 card-container    pt-3 z-1">
                            <a href="<?php echo e(route('viewlotus')); ?>" class="text-decoration-none">
                    ...
                    <div class="swiper-slide ">
                        <div class=" position-relative sec2Macard rounded-3 card-container  pt-3 z-1">
                            <a href="<?php echo e(route('orchid')); ?>" class="text-decoration-none">
                                <div class="px-3 position-relative sec2dH overflow-visible ">
                                    <div class="image-wrapper position-relative ">
                                        <img src="<?php echo e(asset('assets/frontend/img/Rectangle 23.webp')); ?>"
                                            class="sec2ImgMai" alt="Image">
                    ...
                    <div class="swiper-slide ">
                        <div class=" position-relative sec2Macard rounded-3 card-container  pt-3 z-1">
                            <a href="<?php echo e(route('insight')); ?>" class="text-decoration-none">
                                <div class="px-3 position-relative sec2dH overflow-visible ">
                                    <div class="image-wrapper position-relative ">
                                        <img src="<?php echo e(asset('assets/frontend/img/Rectangle 23.webp')); ?>"
                                            class="sec2ImgMai" alt="Image">
                    ...
                    <div class="swiper-slide ">
                        <div class=" position-relative sec2Macard rounded-3 card-container  pt-3 z-1">
                            <a href="<?php echo e(route('anjaeja')); ?>" class="text-decoration-none">
                ...
                <div class="swiper-wrapper  bg-white">
                    <div class="swiper-slide  bg-white">
                        <div class=" position-relative sec2Macard bg-white   rounded-3 card-container    pt-3 z-1">
                            <a href="<?php echo e(route('viewbalaji')); ?>" class="text-decoration-none">
                    ...
                    <div class="swiper-slide  bg-white">
                        <div class=" position-relative sec2Macard bg-white   rounded-3 card-container    pt-3 z-1">
                            <a href="<?php echo e(route('viewbella')); ?>" class="text-decoration-none">
                    ...
                    <div class="swiper-slide  bg-white">
                        <div class=" position-relative sec2Macard bg-white   rounded-3 card-container    pt-3 z-1">
                            <a href="<?php echo e(route('viewmaelite')); ?>" class="text-decoration-none">
                    ...
                    <div class="swiper-slide  bg-white">
                        <div class=" position-relative sec2Macard bg-white   rounded-3 card-container    pt-3 z-1">
                            <a href="<?php echo e(route('viewvedant')); ?>" class="text-decoration-none">
        ...
        <div class="text-center py-5 container">
            ...
            <div class="row pt-4 sec4Pad">
                <div class="col-lg-3 col-6 p-2 mb-4">
                    <img src="<?php echo e(asset('assets/frontend/img/sec4_1.png')); ?>" width="90%" alt="">
                </div>
                <div class="col-lg-3 col-6 p-2 mb-4">
                    <img src="<?php echo e(asset('assets/frontend/img/sec4_2.png')); ?>" width="90%" alt="">
                </div>
                <div class="col-lg-3 col-6 p-2 mb-4">
                    <img src="<?php echo e(asset('assets/frontend/img/sec4_3.png')); ?>" width="90%" alt="">
                </div>
                <div class="col-lg-3 col-6 p-2 mb-4">
                    <img src="<?php echo e(asset('assets/frontend/img/sec4_4.png')); ?>" width="90%" alt="">
                </div>
            </div>
        </div>
    </section>
                            ...
                            <form action="<?php echo e(route('phone_requests.store')); ?>" method="POST">
                                ...
                                <div class="sec6searchbox-wrap">
                                    <input type="text" name="phone_number"
                                        class="<?php $__errorArgs = ['phone_number'];
...
unset($__errorArgs, $__bag); ?>
            ...
            <img src="<?php echo e(asset('assets/frontend/img/sec6bgImg.webp')); ?>" class="position-absolute sec6col2Img"
                alt="">
        </div>
    </section>
    <!-- ========  section 6   END  ======== -->
...
<?php echo $__env->make('frontend.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\propy\propyhome\propyhomes\resources\views/index.blade.php ENDPATH**/ ?>