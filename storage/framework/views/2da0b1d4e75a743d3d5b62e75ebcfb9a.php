        ...
        <div class="container py-4">
            <div class="row">
                ...
                <div class="col-md-4 mb-4 d-flex justify-content-center align-items-center justify-content-lg-end">
                    <div class="">
                        <img src="<?php echo e(asset('assets/frontend/img/fb.svg')); ?>" alt="">
                        <img src="<?php echo e(asset('assets/frontend/img/twitter.svg')); ?>" alt="">
                        <img src="<?php echo e(asset('assets/frontend/img/instragram.svg')); ?>" alt="">
                        <img src="<?php echo e(asset('assets/frontend/img/YouTube.svg')); ?>" alt="">
                        <img src="<?php echo e(asset('assets/frontend/img/in.svg')); ?>" alt="">
                    </div>
                </div>
            </div>
        </div>
