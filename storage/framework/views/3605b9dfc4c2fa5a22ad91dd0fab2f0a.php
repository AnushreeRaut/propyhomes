...
<?php $__env->startSection('content'); ?>
    ...
    <section class="my-5 pt-5">
        <div class="container">
            ...
            <div class="">
                <img src="<?php echo e(asset('assets/frontend/img/KrishnaPrabhabg.png')); ?>" class="rounded-3 height-50vh" alt="">
            </div>
        </div>
    </section>
    <!-- ========  section 1   END  ======== -->
                ...
                <div class="col-xl-8 col-lg-12   mb-xl-2 mb-5">
                            ...
                            <div class="row pt-2">
                                <div class="col-lg-6 col-md-12">
                                    <div class="pe-1 pe-xl-4">
                                        ...
                                        <div class="d-flex pt-2 justify-content-between">
                                            <div class="d-flex">
                                                <h5 class="psec2c1font"><img src="<?php echo e(asset('assets/frontend/img/Kitchen_Room.svg')); ?>"
                                                        class="pe-3 pe-xxl-4" alt=""></h5>
                                        ...
                                        <div class="d-flex pt-2 justify-content-between">
                                            <div class="d-flex">
                                                <h5 class="psec2c1font  "><img src="<?php echo e(asset('assets/frontend/img/livingRoom.svg')); ?>"
                                                        class="pe-3 pe-xxl-4" alt=""></h5>
                                        ...
                                        <div class="d-flex pt-2 justify-content-between">
                                            <div class="d-flex">
                                                <h5 class="psec2c1font  "><img src="<?php echo e(asset('assets/frontend/img/Balcony.svg')); ?>"
                                                        class="pe-3 pe-xxl-4" alt=""></h5>
                                        ...
                                        <div class="d-flex pt-2 justify-content-between">
                                            <div class="d-flex">
                                                <h5 class="psec2c1font  "><img src="<?php echo e(asset('assets/frontend/img/Dining.svg')); ?>"
                                                        class="pe-3 pe-xxl-4" alt=""></h5>
                                        ...
                                        <div class="d-flex pt-2 justify-content-between">
                                            <div class="d-flex">
                                                <h5 class="psec2c1font  "><img src="<?php echo e(asset('assets/frontend/img/WideUtility.svg')); ?>"
                                                        class="pe-3 pe-xxl-4" alt=""></h5>
                    ...
                    <div class="p-4 psec2bordeS   rounded-2 mt-5">
                        <div class="">
                            ...
                            <div class="text-center text-lg-start">
                                <img src="<?php echo e(asset('assets/frontend/img/krish1.png')); ?>" width="100%" alt="" class="rounded-2">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-4 psec2bordeS   rounded-2 mt-5">
                        <div class="">
                            ...
                            <div class=" text-center text-lg-start">
                                <img src="<?php echo e(asset('assets/frontend/img/krishnaTYPICALFLOOR.png')); ?>" width="80%" alt="" class="rounded-2">
                    ...
                    <div class="p-4 psec2bordeS   rounded-2 mt-5">
                        <div class="">
                            ...
                            <div class=" text-center text-lg-start">
                                <img src="<?php echo e(asset('assets/frontend/img/krishnaGroundflool.png')); ?>" width="80%" alt="" class="rounded-2">
...
<?php echo $__env->make('frontend.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\propy\propyhome\propyhomes\resources\views/frontend/topproject/krishna.blade.php ENDPATH**/ ?>